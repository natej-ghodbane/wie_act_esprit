...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        // Neumorphism shadows
        'neuro-sm': '3px 3px 6px #d1d9e6, -3px -3px 6px #ffffff',
        'neuro': '8px 8px 16px #d1d9e6, -8px -8px 16px #ffffff',
        'neuro-lg': '12px 12px 24px #d1d9e6, -12px -12px 24px #ffffff',
        'neuro-xl': '20px 20px 40px #d1d9e6, -20px -20px 40px #ffffff',
        'neuro-inner': 'inset 3px 3px 6px #d1d9e6, inset -3px -3px 6px #ffffff',
        // Dark mode neumorphism
        'neuro-dark-sm': '3px 3px 6px #0f0f0f, -3px -3px 6px #2a2a2a',
        'neuro-dark': '8px 8px 16px #0f0f0f, -8px -8px 16px #2a2a2a',
        'neuro-dark-lg': '12px 12px 24px #0f0f0f, -12px -12px 24px #2a2a2a',
